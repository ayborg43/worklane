...
func (h *Handlers) MountRoutes(mux *http.ServeMux, mw *auth.Middleware) {
	mux.Handle("GET /projects", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.List)))
	mux.Handle("POST /projects", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.Create)))
	mux.Handle("GET /projects/{id}", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.Show)))
	mux.Handle("GET /projects/{id}/tasks/options", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.TaskOptions)))
	mux.Handle("GET /projects/{id}/tasks/{taskID}", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.ShowTask)))
	mux.Handle("POST /projects/{id}/tasks/{taskID}/comments", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.CreateComment)))
	mux.Handle("POST /projects/{id}/tasks", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.CreateTask)))
	mux.Handle("PUT /projects/{id}/tasks/{taskID}", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.UpdateTask)))
	mux.Handle("DELETE /projects/{id}/tasks/{taskID}", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.DeleteTask)))
	mux.Handle("POST /projects/{id}/dependencies", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.AddDependency)))
	mux.Handle("DELETE /projects/{id}/dependencies/{taskID}/{depID}", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.RemoveDependency)))
	mux.Handle("POST /projects/{id}/members", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.AddMember)))
	mux.Handle("DELETE /projects/{id}/members/{userID}", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.RemoveMember)))
	mux.Handle("POST /projects/{id}/milestones", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.CreateMilestone)))
	mux.Handle("DELETE /projects/{id}/milestones/{milestoneID}", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.DeleteMilestone)))
	mux.Handle("POST /projects/{id}/tasks/{taskID}/subtasks", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.CreateSubtask)))
	mux.Handle("POST /projects/{id}/tasks/{taskID}/recurrence", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.SetRecurrence)))
	mux.Handle("POST /projects/{id}/task-templates", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.CreateTaskTemplate)))
	mux.Handle("DELETE /projects/{id}/task-templates/{templateID}", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.DeleteTaskTemplate)))
	mux.Handle("POST /projects/{id}/task-templates/{templateID}/use", mw.RequireAuthAndModule("projects", http.HandlerFunc(h.UseTaskTemplate)))
}
